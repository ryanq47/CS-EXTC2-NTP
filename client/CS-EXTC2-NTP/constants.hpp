...
namespace Beacon {
//Values from here are pulled from this resource: https://github.com/Cobalt-Strike/External-C2/blob/main/extc2example.c
//#define PAYLOAD_MAX_SIZE 512 * 1024
//#define BUFFER_MAX_SIZE 1024 * 1024

    //not used, using vectors instead of a buffer. Makes life easier
    //const size_t payloadMaxSize = 512 * 1024;
    //max size to read from pipe - 1024 * 1024 is in the extc2example.c
